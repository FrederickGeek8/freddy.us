...
|* Sean */
/**
 * Heavily modified by Frederick Morlock
 */
(function($, window) {
  ...
  var tubular = function(node, options) { // should be called on the wrapper div
    ...
    // build container
    var tubularContainer = '<div id="tubular-container" style="overflow: hidden; position: absolute; z-index: ' + options.wrapperZIndex + '; width: 100%; height: 100%"><div id="tubular-player" style="position: absolute"></div></div><div id="tubular-shield" style="width: 100%; height: 100%; z-index: ' + (options.wrapperZIndex + 1) + '; position: absolute; left: 0; top: 0;"></div>';
  ...
  $.fn["tubular"] = function(options) {
    ...
    if (options === undefined || typeof options === 'object') {
      ...
      var returns;
      if (options === 'destroy') {
        $.data(this, 'tubular_instantiated', null);
      }
