...
-->
<figure>
    <img src="/assets/per-post/fuzzy-dynamics/llm_user_interaction.svg" alt="A tiny architecture diagram" class="invertable" width="480" height="430" style="background: #eee; height:auto;" />
